  ...
  void eventListener(dynamic event) {
    ...
    switch (map['event']) {
      ...
      case 'onAddStream':
        ...
        MediaStream stream=_remoteStreams.firstWhere((it) => it.id == streamId,
            orElse: () {
        ...
        if (this.onAddStream != null) this.onAddStream(
            stream, _peerConnectionId);
      ...
      case 'onAddTrack':
        ...
        List<MediaStreamTrack> oldTracks=(kind == 'audio') ? stream
            .getAudioTracks() : stream.getVideoTracks();
    ...
    try {
      ...
      if (response != null) {
        ...
        reports.forEach((report) {
          stats.add(new StatsReport(
              report['id'], report['type'], report['timestamp'],
              report['values']));
        });
      }
      return stats;
